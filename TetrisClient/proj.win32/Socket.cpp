...
void Socket::PutPacket(ServerMessage::MessageType packetType, ::google::protobuf::Message* message)
{
	if (message == nullptr)
	{
		return;
...
void Socket::SendPacket(ServerMessage::MessageType packetType, ::google::protobuf::Message* message)
{
	if (m_hSocket == INVALID_SOCKET)
	{
		return;
